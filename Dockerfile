...
# build stage
FROM ghcr.io/linuxserver/baseimage-ubuntu:jammy as buildffmpeg
...
RUN wget "https://github.com/lay295/TwitchDownloader/releases/download/1.54.2/TwitchDownloaderCLI-1.54.2-Linux-x64.zip" \
    && unzip -j TwitchDownloaderCLI-1.54.2-Linux-x64.zip "TwitchDownloaderCLI" -d /usr/local/bin/ \
    && rm TwitchDownloaderCLI-1.54.2-Linux-x64.zip \
